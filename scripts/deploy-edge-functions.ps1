...
#
# All six functions are deployed sequentially. The script exits on first failure.
param(
...
$Functions = @("coach", "transcribe", "generate-skill", "transcribe-chunk", "report-error", "run-skill")
